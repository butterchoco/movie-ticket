...
public class PDFView extends AbstractPdfView {
    protected void buildPdfDocument(Map model,
        ...
        Paragraph header = new Paragraph(new Chunk("Cinema:\t" + ticket.getCinema(),
                            FontFactory.getFont(FontFactory.HELVETICA, 50)));
        Paragraph by = new Paragraph(new Chunk("Date:\t" + ticket.getDate() + "\n" + "Showtime:\t" + ticket.getShowtime()
                         + "\n" + "Seat/Row:\t" + ticket.getSeat() + "Auditorium:\t" + ticket.getAudi(),
